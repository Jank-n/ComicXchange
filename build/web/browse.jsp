...
<html>
    <head>
        ...
        <title>ComicXchange-Browse</title>
    ...
    <body>
        ...
        <h2 style="padding: 10px">All Comics</h2>
        
        <% 
            while(rs.next()) {
        %>
            <div class="container" id="comicgrid">
            ...
            <div class="col-md-6 grid-item">
                ...
                <h6>Author: <%=rs.getString("Author")%> - Genre: <%=rs.getString("Genre")%></h6>
